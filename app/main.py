...
from app.api.network_profiles import router as network_profiles_router
...
async def lifespan(app: FastAPI):
    try:
        ...
        logger.warning(
            ...
            "El servidor seguirá activo, pero las operaciones "
            "que usen la base de datos fallarán hasta que "
...
app.include_router(network_profiles_router)
